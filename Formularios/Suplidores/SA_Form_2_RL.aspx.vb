...
Public Class SA_Form_2_RL
    ...
    Sub preCargaDatos()
        ...
        Dim modeloRepLegal = RepLegalNegocio.Instancia.cargarRLSuplidor(Session("Inscripcion"))
    ...
    Protected Sub btnSiguiente_ServerClick(sender As Object, e As EventArgs)
        ...
        If chkTieneRep.Checked Then
            ...
            RepLegalNegocio.Instancia.insertarRLSuplidor(Session("Inscripcion"), txtCedula.Value, txtNombre.Value.ToUpper(),
