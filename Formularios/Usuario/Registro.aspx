<%@ Page MaintainScrollPositionOnPostback="true" Language="vb" AutoEventWireup="false" CodeBehind="Registro.aspx.vb" Inherits="Formularios.Registro" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-izq-etiquetas">
                    <label for="cbTipoCedula">Seleccione el tipo de cédula</label>
                </div>
                <div class="col-centro-entradas">
                    <telerik:radcombobox id="cbTipoCedula" runat="server" autopostback="True" width="100%" rendermode="Auto" cssclass="sombra-caja " emptymessage="-- Seleccione --"></telerik:radcombobox>
                </div>
                <div class="col-der-espacio"></div>
            </div>
                ...
                <div class="col-centro-entradas">
                    ...
                    <div class="form-text">
                        * Ingrese su cédula sin guiones ni espacios. Asegúrese de incluir todos los ceros necesarios: 
                        9 dígitos para ciudadanos nacionales, 10 dígitos para personas jurídicas y 12 dígitos para DIMEX.
                    </div>
                </div>
                <div class="col-der-espacio"></div>
            </div>
            ...
            <div class="row">
                <div class="col-izq-espacio"></div>
                <div class="col-izq-etiquetas">
                    <label for="txtNombre">Nombre de persona o empresa</label>
                </div>
                <div class="col-centro-entradas">
                    ...
                    <div class="form-text" id="infoNombre">
                        * Ingrese su nombre completo. Para personas físicas, incluya sus dos nombres y dos apellidos. 
                        Para personas jurídicas, ingrese el nombre exacto registrado en el Ministerio de Hacienda.
                    </div>
                </div>
                <div class="col-der-espacio"></div>
            </div>
