<%@ page maintainscrollpositiononpostback="true" language="vb" autoeventwireup="false" codebehind="PP_Form_5_Aviso.aspx.vb" inherits="Formularios.PP_Form_5_Aviso" %>
    ...
    <form id="form" runat="server" class="justify-content-center">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-izq-espacio"></div>
                <div style="width: 50%">
                    <button id="btnSiguiente" runat="server" autopostback="True" style="width: 100%" class="btn sombra-caja" disabled onserverclick="btnSiguiente_Click">Enviar Solicitud</button>
                </div>
                <div class="col-der-espacio"></div>
            </div>
            <br />
