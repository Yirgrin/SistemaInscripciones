<%@ Page MaintainScrollPositionOnPostback="true" Language="vb" AutoEventWireup="false" CodeBehind="UI_Pendientes_PP.aspx.vb" Inherits="Formularios.UI_Pendientes_PP" %>
...
<head runat="server">
    ...
    <title>Pendientes Productor Primario</title>
...
<body id="body-pd">
    <form id="form1" runat="server">
        ...
        <br />
            ...
            <telerik:radgrid
                id="rgInscripcionesPP"
                runat="server"
                onitemdatabound="rgInscripcionesPP_ItemDataBound"
                ...
                cssclass="sombra-caja">
					<mastertableview commanditemdisplay="Top" datakeynames="codigo, cedula" width="100%">
