<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UI_Archivo_SA.aspx.vb" Inherits="Formularios.UI_Archivo_SA" %>
...
<head runat="server">
    ...
    <title>Pendientes Suplidor de Acopio</title>
...
<body id="body-pd">
    <form id="form1" runat="server">
        ...
        <telerik:radgrid
            id="rgArchivoSA"
            runat="server"
            onitemdatabound="rgArchivoSA_ItemDataBound"
            ...
            cssclass="sombra-caja">
					<mastertableview commanditemdisplay="Top" datakeynames="codigo" width="100%">
						...
						<Columns>
                            ...
                            <telerik:GridBoundColumn DataField="cedula" HeaderText="Cedula" UniqueName="cedula"></telerik:GridBoundColumn>
