<%@ page language="vb" autoeventwireup="false" codebehind="VW_Inscrip_4_CertPP.aspx.vb" inherits="Formularios.VW_Inscrip_4_CertPP" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="divBotones" runat="server">
                ...
                <div class="col-centro-entradas">
                    ...
                    <button id="btnPaginaSiguiente" runat="server" autopostback="True" style="width: 100%" class="btn sombra-caja" onserverclick="btnPaginaSiguiente_ServerClick">Página Siguiente</button>
                </div>
                </div>
            ...
            <div class="row" id="divRechazar" runat="server">
                <div class="col-izq-espacio"></div>
                <div class="col-izq-etiquetas">
                    <label for="txtNoResolucion">Resolución N°: </label>
                </div>
                <div class="col-centro-entradas">
