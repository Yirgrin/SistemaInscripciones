<%@ page language="vb" autoeventwireup="false" codebehind="UI_Archivo_PP.aspx.vb" inherits="Formularios.UI_Archivo_PP" %>
...
<head runat="server">
    ...
    <title>Archivo Inscripciones PP</title>
...
<body id="body-pd">
    <form id="form1" runat="server">
        ...
        <telerik:radgrid
            id="rgArchivoPP"
            runat="server"
            onitemdatabound="rgArchivoPP_ItemDataBound"
